...
@available(*, deprecated, message: "Use HintViewStyle")
public struct OldHintViewStyle {
    ...
    public func update(
        variant: Variant,
        viewProperties: inout OldHintView.ViewProperties
    ) {
...
public extension OldHintViewStyle.Variant {
